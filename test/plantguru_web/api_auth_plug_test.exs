defmodule PlantGuruWeb.APIAuthPlugTest do
    use PlantGuruWeb.ConnCase
    doctest PlantGuruWeb.APIAuthPlug
  
    alias PlantGuruWeb.{APIAuthPlug, Endpoint}
    alias PlantGuru.{Repo, Users.User}
  
    @pow_config [otp_app: :plantguru]
